...
# NeuralShift-specific schema for contact/inquiry submissions
class Inquiry(BaseModel):
    """
    Contact inquiries from the NeuralShift website
    ...
    audience: Optional[str] = Field(None, description="B2B or B2C")
